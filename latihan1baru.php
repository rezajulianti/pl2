    ...
    ?>
        ...
        <td><a href="latihan3baru.php?id=<?php echo $data['id']; ?>">Edit</a> | 
            <a href="latihan4baru.php?id=<?php echo $data['id']; ?>">Delete</a></td>
    </tr>
    ...
    <font size="4"><a href="latihan2baru.php" class="btn btn-success pull-right">Insert Mahasiswa</a>
